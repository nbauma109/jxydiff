...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        try (ZipFile zip = new ZipFile(file);
            ...
            xmlReader.setFeature("http://xml.org/sax/features/use-attributes2", false);
            xmlReader.setFeature("http://xml.org/sax/features/use-locator2", false);
            ...
            xmlReader.setProperty("http://xml.org/sax/properties/declaration-handler", false);
            xmlReader.setProperty("http://xml.org/sax/properties/dom-node", false);
            xmlReader.setProperty("http://xml.org/sax/properties/lexical-handler", false);
            xmlReader.setProperty("http://xml.org/sax/properties/xml-string", false);
